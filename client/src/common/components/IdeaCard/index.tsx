...
function IdeaCard({ idea }: { idea: Idea.Idea }) {
  ...
  return (
    <div className="relative flex items-center w-full text-on-150">
      <Link
        href={`/idea/${id}`}
        className="flex w-full px-3 py-2 sm:px-4 sm:py-3 rounded-xl bg-types-100 border-types-100 group hover:bg-types-150 animate"
      >
