    ...
    <div className="max-w-full">
      ...
      <textarea
        ...
        className={concat(
          ...
          'focus:text-white w-full h-full px-4 py-3 transition duration-150 ease-out rounded-lg outline-none scrollbar-none border border-types-150 bg-types-100/50 input-field',
        )}
      />
